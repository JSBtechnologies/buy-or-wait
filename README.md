...
> The solution lives in [`code/`](code/). Run the commands below from `code/`.
...
The full design document with LaTeX/TikZ diagrams is [`docs/architecture.pdf`](code/docs/architecture.pdf) (source: `code/docs/architecture.tex`).
